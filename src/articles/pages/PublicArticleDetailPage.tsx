	...
	return (
		<div className='relative min-h-screen bg-slate-50/30 py-12 md:py-20 font-sans'>
			...
			<div className='container mx-auto px-4 max-w-4xl relative z-10'>
				...
				<div className='w-full aspect-16/10 md:aspect-21/9 rounded-4xl overflow-hidden bg-gray-100 mb-12 shadow-[0_20px_50px_rgb(0,0,0,0.05)] border border-gray-100 relative'>
					<img
