...
import EventForm from "@/components/kegiatan/kegiatanForm";
import EventTable from "@/components/kegiatan/kegiatanTable";
import JadwalJumatPage from "@/pages/admin/JadwalSholatJumat";
