...
import {
  Search, Download, MoreVertical, CheckCircle2,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {STAT_ROWS.map(({ icon:Icon, label, wrap, sub }, i) => (
          <div key={i} className="stat-card min-w-0">
            <div className={wrap}><Icon className="size-5"/></div>
            <div className="min-w-0">
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{label}</p>
              <p className="break-words text-xl font-black text-gray-900">{statValues[i]}</p>
      ...
      <div className="card overflow-hidden">
        ...
        {/* Toolbar */}
        <div className="flex flex-col items-start justify-between gap-3 border-b border-gray-50 px-4 py-4 sm:flex-row sm:items-center sm:px-6">
          ...
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
            ...
            <div className="filter-group max-w-full overflow-x-auto">
              {FILTERS.map(f => (
                <Button key={f.key}
        ...
        {/* Pagination */}
        <div className="flex flex-col gap-3 border-t border-gray-50 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
