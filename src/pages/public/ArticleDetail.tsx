...
const DUMMY_ARTICLES = [
  {
    ...
    firstParagraph: "Masjid bukan hanya tempat untuk melaksanakan shalat lima waktu, tetapi juga pusat kegiatan umat Islam. Oleh karena itu, menjaga kebersihan dan kenyamanan masjid adalah tanggung jawab kita bersama. Lingkungan yang bersih akan menambah kekhusyukan dalam beribadah.",
    quote: "Kesucian (kebersihan) itu adalah sebagian dari iman.",
    quoteSource: "HR. Muslim",
    subheading: "Langkah Nyata Memakmurkan Masjid",
    lastParagraph: "Memakmurkan masjid tidak selalu berarti membangun bangunan yang megah. Menjaga kebersihan karpet, merapikan sandal di luar, dan memastikan tempat wudhu bersih juga merupakan bentuk memakmurkan masjid."
  },
  {
    id: 2,
    ...
    firstParagraph: "Shalat subuh berjamaah adalah salah satu ibadah yang paling berat namun memiliki ganjaran yang luar biasa. Banyak umat Islam yang belum menyadari bahwa fajar adalah waktu di mana keberkahan diturunkan secara melimpah bagi mereka yang melangkah ke masjid.",
    quote: "Dua rakaat shalat fajar lebih baik dari dunia dan seisinya.",
    quoteSource: "HR. Muslim",
    subheading: "Disaksikan oleh Para Malaikat",
    lastParagraph: "Mari kita kuatkan tekad untuk meramaikan shaf subuh. Dengan memulai hari di rumah Allah, kita mengundang keberkahan untuk seluruh aktivitas kita hingga matahari terbenam."
  },
  {
    id: 3,
    ...
    firstParagraph: "Sebagai bentuk transparansi dan amanah pengelola dana umat, kami sampaikan laporan keuangan ZISWAF untuk periode April 2026. Dana yang terkumpul telah disalurkan untuk berbagai program pemberdayaan ekonomi dan bantuan sosial bagi jamaah yang membutuhkan.",
    ...
    lastParagraph: "Kami mengucapkan jazakumullah khairan katsiran kepada seluruh donatur. Semoga harta yang diinfakkan menjadi pembersih jiwa dan pembuka pintu rezeki yang berkah."
  }
];
    ...
    <div className="relative min-h-screen bg-slate-50/30 py-12 md:py-20 font-sans">
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        <Link to="/artikel" className="inline-flex mb-8 md:mb-12">
          <Button variant="ghost" className="hover:bg-emerald-50 hover:text-simas-primary transition-colors text-gray-500 font-medium -ml-2 rounded-xl px-4 h-10">
