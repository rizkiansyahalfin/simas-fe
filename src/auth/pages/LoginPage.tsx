...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // dummy login logic
    const dummyAccounts: Record<string, { id: string; name: string; role: 'superadmin' | 'bendahara' | 'sekretaris' | 'operator' | 'admin kegiatan' | 'admin inventaris' }> = {
      "admin@simas.com":       { id: "1", name: "Super Admin",      role: "superadmin" },
      "bendahara@simas.com":   { id: "2", name: "Bendahara",        role: "bendahara" },
      "sekretaris@simas.com":  { id: "3", name: "Sekretaris",       role: "sekretaris" },
      "operator@simas.com":    { id: "4", name: "Operator",         role: "operator" },
      "adminkegiatan@simas.com":  { id: "5", name: "Admin Kegiatan",   role: "admin kegiatan" },
      "admininventaris@simas.com": { id: "6", name: "Admin Inventaris", role: "admin inventaris" },
    };

    if (password === "123456" && dummyAccounts[email]) {
      const { id, name, role } = dummyAccounts[email];
      setAuth({
        token: "dummy-token",
