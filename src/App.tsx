import { Routes, Route } from "react-router-dom"; // <-- Navigate dihapus

// Layouts
import AdminLayout from "@/layouts/AdminLayout";
// import AuthLayout dari sini gw hapus karena belum lu pakai di dalam rute
...
// Cukup satu export default di sini aja
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/agenda" element={<PublicLayout><Events /></PublicLayout>} />
...
// Baris "export default App;" yang di bawah tadi udah gw buang biar nggak dobel